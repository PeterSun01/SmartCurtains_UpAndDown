                      ...
                      int* Height,int* Angle)
{
    ...
    ESP_LOGI(TAG, "N0=%f",N0);
    t=N-N0;
    ESP_LOGI(TAG, "t=%f",t);
    Fsun=2*PI*t/365.2422;
    ESP_LOGI(TAG, "Fsun=%f",Fsun);
